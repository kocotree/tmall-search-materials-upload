...
description: Use for starting, configuring, testing, resuming, reviewing, auditing, dry-running, approving, or uploading Tmall search-recommendation materials. Always open or resume the interaction UI before requesting store names, months, image-source roots, product choices, media decisions, slot edits, copy, approval, or production confirmation in chat.
---
...
3. Follow the canonical frontend-first startup contract. Missing store, month, image roots, NAS access, or login are not startup blockers.
4. Use the managed UI launcher documented by the canonical Skill. Codex chat is only a reason-coded fallback after a real frontend failure.

Generated from canonical SHA-256:
`e70946b78f38f33bedb6ad1dc70de49877a0a9f03717605d818cbcd94d179ae8`
