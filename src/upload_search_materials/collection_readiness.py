...
DEFAULT_CANDIDATE_SELECTORS = {
    ...
    "safe_popup_close_priority": (
        ...
        '[class*="AiImageGenerationOfflinePushModal_customCloseBtn"], '
        '.ant-modal-wrap.ant-modal-centered '
        'button[class*="AiImageGenerationOfflinePushModal_cancelBtn"], '
        '.ant-modal-wrap.ant-modal-centered '
        ...
        '.next-overlay-wrapper.opened [aria-label*="关闭"], '
        ...
        '.next-overlay-wrapper.v2.opened svg.next-icon-remote, '
        '#react-joyride-portal [class*="GuideBalloon_"]'
        '[class*="close"], '
        '#react-joyride-portal [class*="GuideBalloon_"]'
        '[class*="Close"], '
